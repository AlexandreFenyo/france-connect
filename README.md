...
Une fois en régime permanent, le CPU de la machine virtuelle KIF est chargé à près de 100%, son utilisation est répartie comme suit :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODExOTE4NDddfQ==
-->