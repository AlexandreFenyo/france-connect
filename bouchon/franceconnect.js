...
(function (window) {
    var fconnect = {
        tracesUrl: '/traces.html',
        aboutUrl: '/en-savoir-plus.html'
    };
    ...
    function includeFCCss() {
        ...
        for (var i = 0, max = ss.length; i < max; i++) {
            if (ss[i].href == 'http://' + fconnect.currentHost + '/franceconnect.css' || ss[i].href == 'https://' + fconnect.currentHost + '/franceconnect.css')
                return;
        }

        var linkCss = document.createElement('link');
        linkCss.rel = 'stylesheet';
        linkCss.href = '//' + fconnect.currentHost + '/franceconnect.css';
